...
const int ALTURA_TELA = 444;

ALLEGRO_DISPLAY *janela = NULL;
ALLEGRO_EVENT_QUEUE *fila_eventos = NULL;
ALLEGRO_BITMAP *fundo = NULL, *personagem=NULL;
...
int inicializar()
{
    ...
    fundo = al_load_bitmap("Sky.png");
    personagem = al_load_bitmap("sprite2.png");
    al_convert_mask_to_alpha(personagem, al_map_rgb(30,34,253));
...
int main(void)
{
    ...
    float v=5;
    float dx=0, dy=0, Px1 = 20, Py1=20, Px2=39, Py2=56, Rx1=50, Ry1=50, Rx2=100, Ry2=100;
    int tecla=0, sair=0;
    while(!sair){
        ...
        al_draw_bitmap(personagem, Px1 + dx, Py1 +dy, 0);
        al_flip_display();
        al_rest(1.0/60.0);
    }
    al_destroy_display(janela);
